  ...
  return (
    <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
      ...
      <button
        type="button"
        disabled
        className="w-full flex items-center justify-center gap-3 bg-white/10 text-white/30 font-semibold rounded-xl px-4 py-3 mb-4 cursor-not-allowed min-h-[48px]"
      >
